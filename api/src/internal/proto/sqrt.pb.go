...
type SqrtRequest struct {
	...
	Num int64 `protobuf:"varint,1,opt,name=num,proto3" json:"num,omitempty"` // could be uint32
}
...
func (x *SqrtRequest) GetNum() int64 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *SqrtResponse) GetAns() float64 {
	if x != nil {
		return x.Ans
	}
	return 0
...
var file_sqrt_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x73, 0x71, 0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x1f, 0x0a, 0x0b, 0x53, 0x71, 0x72, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x20, 0x0a, 0x0c, 0x53, 0x71, 0x72,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x6e, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x03, 0x61, 0x6e, 0x73, 0x42, 0x21, 0x5a, 0x1f, 0x76,
	0x6f, 0x69, 0x63, 0x65, 0x2d, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2f,
...
var file_sqrt_proto_goTypes = []interface{}{
	(*SqrtRequest)(nil),  // 0: translator.SqrtRequest
	(*SqrtResponse)(nil), // 1: translator.SqrtResponse
}
